...
import { GroupDocument } from '../../../../core/domain/interfaces/IGroups';

export interface IGroupSocketService {
  createGroup(socket: Socket, data: GroupDocument, callback: (response: any) => void): Promise<void>;
  updateGroup(socket: Socket, data: GroupDocument, callback: (response: any) => void): Promise<void>;
