...
const SubscriptionStatus: React.FC = () => {
  ...
  // ✅ If coming back from Stripe redirect with success
useEffect(() => {
  const handleRedirect = async () => {
    try {
      ...
      if (redirectStatus === "succeeded") {
        console.log("🔄 Redirect returned success from Stripe");
        setStep("success");
  ...
  if (subscription?.isSubscribed && !isExpired) {
    return (
      <div className="h-[500px] overflow-y-auto p-6 bg-white dark:bg-gray-800 shadow-md border border-green-200 dark:border-green-600 rounded-lg space-y-6">
  ...
  // ✅ Case 2: Expired or Not Subscribed
  return (
    <div className="fixed inset-0 z-50 bg-white dark:bg-gray-900 overflow-auto p-6 md:p-12">
          ...
          <>
            <div className="space-y-4 text-center">
              <div className="flex justify-center items-center gap-2 text-red-600 dark:text-red-400 font-medium">
                ...
                <p className="text-xl">
                  {subscription ? "Subscription expired" : "Not Subscribed"}
                </p>
              </div>
