...
return (
  <div className="w-full max-w-2xl mx-auto px-6 py-6 sm:px-8 sm:py-8 pb-20 bg-white dark:bg-gray-900 text-black dark:text-white rounded-2xl shadow-lg space-y-4">
